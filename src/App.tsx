...
//                 <span className="text-white font-bold text-lg">G</span>
//               </div> */}
//                <div className="w-12 h-12 rounded-xl flex items-center justify-center shadow-lg shadow-orange-300/30 group-hover:shadow-[#FF7F50]/50 transition-all duration-300 group-hover:scale-110">
//                 <img src={logo}/>
//               </div>
//               <div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-slate-50/30 to-blue-50/30 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div
          className="absolute top-3/4 right-1/4 w-96 h-96 bg-gradient-to-r from-blue-300/20 to-slate-300/20 rounded-full blur-3xl animate-pulse"
          style={{ animationDelay: "1s" }}
        ></div>
        <div
          className="absolute bottom-1/4 left-1/2 w-96 h-96 bg-gradient-to-r from-gray-300/20 to-slate-400/20 rounded-full blur-3xl animate-pulse"
          style={{ animationDelay: "2s" }}
        ></div>

        {/* Interactive Mouse Glow */}
        <div
          className="absolute w-96 h-96 bg-gradient-to-r from-slate-400/15 to-blue-400/15 rounded-full blur-3xl pointer-events-none transition-all duration-300"
          style={{
            left: mousePosition.x - 192,
            top: mousePosition.y - 192,
          }}
        ...
        {/* Animated Grid */}
        <div className="absolute inset-0 bg-[linear-gradient(rgba(100,116,139,0.05)_1px,transparent_1px),linear-gradient(90deg,rgba(100,116,139,0.05)_1px,transparent_1px)] bg-[size:50px_50px] [mask-image:radial-gradient(ellipse_80%_50%_at_50%_0%,#000_70%,transparent_110%)]"></div>
      </div>

      {/* Header */}
      <header className="fixed top-0 left-0 right-0 bg-white/90 backdrop-blur-xl border-b border-slate-200/50 z-50 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            {/* Logo */}
            <div className="flex items-center space-x-3 group">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              <a
                href="#home"
                className="text-slate-700 hover:text-blue-600 transition-all duration-300 hover:scale-105 relative group font-medium"
              >
                Home
      ...
      >
        <div className="max-w-7xl mx-auto text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-8 inline-block">
              <span className="px-6 py-3 bg-gradient-to-r from-slate-50 to-blue-50 border border-slate-200 rounded-full text-blue-700 text-sm font-semibold backdrop-blur-sm animate-pulse shadow-sm">
                ✨ Welcome to the Future of Software
              </span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <a
                href="#services"
                className="group inline-flex items-center px-8 py-4 bg-gradient-to-r from-slate-600 to-blue-600 text-white rounded-xl hover:from-slate-700 hover:to-blue-700 transition-all duration-300 transform hover:scale-105 shadow-xl shadow-slate-300/30 hover:shadow-slate-400/50 font-semibold"
              >
                <span className="mr-2">Explore Services</span>
                <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </a>
              <a
                href="#contact"
                className="inline-flex items-center px-8 py-4 border-2 border-slate-600 text-blue-700 rounded-xl hover:border-blue-600 hover:text-slate-600 hover:shadow-lg hover:shadow-slate-300/25 transition-all duration-300 backdrop-blur-sm bg-white/70 font-semibold"
              >
                Get in Touch
              </a>
            </div>
      ...
      <section className="py-16 relative z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <div key={index} className="text-center group">
                <div className="bg-white/80 backdrop-blur-xl rounded-2xl p-6 border border-slate-200 hover:border-slate-300 transition-all duration-300 transform hover:scale-105 shadow-sm hover:shadow-md">
                  <div
                    className={`${stat.color} mb-3 flex justify-center group-hover:scale-110 transition-transform`}
                  >
                    {stat.icon}
      ...
      <section id="services" className="py-20 relative z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <div className="mb-6 inline-block">
              <span className="px-6 py-3 bg-gradient-to-r from-slate-50 to-blue-50 border border-slate-200 rounded-full text-blue-700 text-sm font-semibold backdrop-blur-sm shadow-sm">
                🚀 Our Expertise
              </span>
            </div>
            <h3 className="text-4xl sm:text-5xl font-bold mb-6">
                  ...
                  <div className="space-y-2">
                    {service.features.map((feature, featureIndex) => (
                      <div
                        ...
                        className="flex items-center text-sm text-slate-500 group-hover:text-slate-600 transition-colors"
                      >
                        <Star className="w-3 h-3 mr-2 text-slate-500" />
                        {feature}
                      </div>
                    ))}
                  </div>
      ...
      <section id="about" className="py-20 relative z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-16">
              <div className="mb-6 inline-block">
                <span className="px-6 py-3 bg-gradient-to-r from-blue-50 to-slate-50 border border-blue-200 rounded-full text-blue-700 text-sm font-semibold backdrop-blur-sm shadow-sm">
                  💡 Our Story
                </span>
              </div>
              <h3 className="text-4xl sm:text-5xl font-bold mb-8">
            ...
            <div className="bg-white/80 backdrop-blur-xl rounded-3xl p-8 md:p-12 border border-slate-200 relative overflow-hidden shadow-sm">
              {/* Background Pattern */}
              <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(100,116,139,0.05),transparent)] pointer-events-none"></div>

              <div className="relative z-10 text-lg text-slate-700 leading-relaxed space-y-8">
                <p className="text-xl">
                  <span className="bg-gradient-to-r from-slate-600 to-blue-600 bg-clip-text text-transparent font-semibold">
                    Gisvic
                  </span>{" "}
                  is a forward-thinking software development company dedicated
                  to solving business problems through innovative technology
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
                  <div className="text-center p-6 bg-white/70 rounded-xl border border-slate-200 hover:bg-white/90 transition-all duration-300">
                    <div className="text-2xl font-bold text-slate-800 mb-2">
                      Innovation
                    </div>
                    <div className="text-slate-600">Cutting-edge solutions</div>
              ...
              {/* Decorative Elements */}
              <div className="absolute top-6 right-6 w-20 h-20 bg-gradient-to-r from-slate-400/30 to-blue-400/30 rounded-full blur-xl"></div>
              <div className="absolute bottom-6 left-6 w-16 h-16 bg-gradient-to-r from-blue-300/30 to-slate-300/30 rounded-full blur-xl"></div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
              ...
              <div className="text-center group">
                <div className="w-16 h-16 bg-gradient-to-r from-blue-600 to-slate-600 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg shadow-blue-300/30 group-hover:shadow-blue-400/50 group-hover:scale-110 transition-all duration-300">
                  <Phone className="w-8 h-8 text-white" />
                </div>
                <h4 className="font-semibold text-slate-800 mb-3 text-lg">
                  Call Us
              ...
              <div className="text-center group">
                <div className="w-16 h-16 bg-gradient-to-r from-gray-600 to-slate-600 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg shadow-gray-300/30 group-hover:shadow-gray-400/50 group-hover:scale-110 transition-all duration-300">
                  <MapPin className="w-8 h-8 text-white" />
                </div>
                <h4 className="font-semibold text-slate-800 mb-3 text-lg">
                  Visit Us
            ...
            <div className="bg-white/80 backdrop-blur-xl rounded-3xl p-8 md:p-12 border border-slate-200 relative overflow-hidden shadow-sm">
              {/* Background Effects */}
              <div className="absolute inset-0 bg-gradient-to-br from-slate-50/50 via-blue-50/50 to-gray-50/50"></div>
              <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-slate-400/20 to-blue-400/20 rounded-full blur-3xl"></div>
              <div className="absolute bottom-0 left-0 w-32 h-32 bg-gradient-to-br from-blue-300/20 to-slate-300/20 rounded-full blur-3xl"></div>
              ...
              <form onSubmit={handleSubmit} className="relative z-10 space-y-8">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div className="group">
                    ...
                    <input
                      ...
                      value={formData.firstName}
                      onChange={handleInputChange}
                      className="w-full px-4 py-4 rounded-xl bg-white/90 border border-slate-200 text-slate-800 placeholder-slate-500 focus:ring-2 focus:ring-slate-500 focus:border-transparent transition-all duration-300 backdrop-blur-sm hover:bg-white"
                      placeholder="Your first name"
                      required
                    />
                  </div>
                ...
                <div className="group">
                  ...
                  <textarea
                    ...
                    value={formData.projectDetails}
                    onChange={handleInputChange}
                    className="w-full px-4 py-4 rounded-xl bg-white/90 border border-slate-200 text-slate-800 placeholder-slate-500 focus:ring-2 focus:ring-slate-500 focus:border-transparent transition-all duration-300 backdrop-blur-sm hover:bg-white resize-none"
                    placeholder="Tell us about your project..."
                    required
                  />
                </div>
